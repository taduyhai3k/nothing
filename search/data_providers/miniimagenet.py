...
class MiniImagenetDataProvider(DataProvider):

    def __init__(self, save_path=None, train_batch_size=256, test_batch_size=512, valid_size=0.2,
    ...
    def save_path(self):
        if self._save_path is None:
            self._save_path = '/kaggle/input/miniimagenet'
